...
func InitApp() *App {
	...
	articleTopnCache := cache.NewArticleTopnCacheImpl(cmdable)
	interactiveRepository := repository.NewCachedInteractiveRepository(interactiveDAO, interactiveCache, articleTopnCache, loggerV1)
