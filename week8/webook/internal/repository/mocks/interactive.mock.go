...
// Source: internal/repository/interactive.go
...
func (m *MockInteractiveRepository) GetTopN(ctx context.Context, n int) ([]domain.ArticlTopN, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTopN", ctx, n)
	ret0, _ := ret[0].([]domain.ArticlTopN)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTopN indicates an expected call of GetTopN.
func (mr *MockInteractiveRepositoryMockRecorder) GetTopN(ctx, n interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTopN", reflect.TypeOf((*MockInteractiveRepository)(nil).GetTopN), ctx, n)
}
