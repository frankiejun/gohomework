...
func (m *MockInteractiveService) GetTopN(ctx context.Context, n int) ([]domain.ArticlTopN, error) {
	m.ctrl.T.Helper()
...
func (mr *MockInteractiveServiceMockRecorder) GetTopN(ctx, n interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTopN", reflect.TypeOf((*MockInteractiveService)(nil).GetTopN), ctx, n)
}
